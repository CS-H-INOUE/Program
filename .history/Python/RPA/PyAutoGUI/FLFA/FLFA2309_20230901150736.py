...
try:
    ...
    # GUIで選択したデータを取得
    selected_data = None  # 選択されたデータを保持する変数
    def handle_option_selection(option, options_window):
        nonlocal selected_data  # 不要な nonlocal キーワードを削除
    ...
    if selected_data is not None:
        # 選択されたデータに応じて操作アクションを設定
        input_actions = [
            # ここに選択されたデータに応じた操作アクションを追加する
        ]
